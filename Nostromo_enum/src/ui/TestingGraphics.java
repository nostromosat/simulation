...
//		public TestingPanelGraphics(JFrame frame, Dimension dim, Point locate){
//			setLayout(new BorderLayout());
//			this.setPreferredSize(dim);
//			this.setLocation(locate);
//			frame.add(new DrawStuff(), BorderLayout.CENTER);
//			revalidate();
//			repaint();
//			this.setVisible(true); //probably not necessary
//		}
		...
		public class DrawStuff extends JComponent{
			...
			protected void paintComponent(Graphics g){
				...
				Shape rootRect = new Rectangle2D.Float(xPos, yPos, width, height);
				...
				try {
					...
					graph2.drawImage(earth, (int)orbit[0][0]+xOrigin/2-marge*2, (int)orbit[1][0]+yOrigin-marge, marge*2, marge*2, this);
